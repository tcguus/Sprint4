export default function Menu() {
  return (
    <nav className="h-[3rem] flex w-full hidden sticky top-0 bg-white dark:bg-escuro border-b-cinza border-b-2 dark:border-cinzaescuro transition duration-300 tb:block">
