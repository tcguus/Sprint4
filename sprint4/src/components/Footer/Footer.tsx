      ...
      <div className="w-[33vw] flex flex-col justify-center items-end">
        <div className="flex flex-col items-center pr-[1rem] gap-2">
          ...
          <div className="flex gap-8 text-right items-center">
            <a href="https://apps.apple.com/br/app/porto-seguros-cartão-e/id1511026277" target="_blank" rel="noopener noreferrer" className="transition duration-300 hover:text-azul">
              <IoIosAppstore className="text-3xl" />
            </a>
            <a href="https://play.google.com/store/apps/details?id=br.com.portoseguro.experienciacliente.mundoporto&pcampaignid=web_share" target="_blank" rel="noopener noreferrer" className="transition duration-300 hover:text-azul">
