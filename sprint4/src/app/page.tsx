        ...
        <div className="flex flex-col w-full">
          <div className="w-full flex flex-col items-center text-white bg-bannerImg bg-no-repeat bg-cover bg-opacity-50 min-h-[calc(100vh-7rem)]">
            ...
            <p className="text-center w-[70%] font-semibold text-xl mt-[3rem]">
              ...
              fornecer precisão na hora de achar a oficina certa para você.
              Nosso sistema possuí uma Inteligência artificial que analisa os
              sintomas de seu veículo e fornece um possível problema e
              orçamento, já te redirecionando a oficinas prontas para consertar
              seu veículo.
            </p>
            <div className="flex w-[70%] h-auto justify-between mt-[3rem] font-bold">
              <div className="flex flex-col w-[33.3%] items-center">
                ...
                <p className="text-center m-4">
                  Obtenha um diagnóstico detalhado e preciso dos problemas do
                  seu veículo, com total confiança
                </p>
              </div>
              <div className="flex flex-col w-[33.3%] items-center">
                <div className="rounded-full p-4 flex items-center justify-center w-[6.5rem] h-[6.5rem] bg-white dark:bg-preto transition duration-300 bg-opacity-70 dark:bg-opacity-90">
                ...
                <p className="text-center m-4">
                  Obtenha uma estimativa clara e transparente dos custos antes
                  de iniciar qualquer serviço.
                </p>
              </div>
              <div className="flex flex-col w-[33.3%] items-center">
                ...
                <p className="text-center m-4">
                  Escolha entre mecânicas qualificadas e altamente recomendadas
                  para um serviço confiável.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex mt-auto mb-auto justify-evenly">
              <div className="flex flex-col bg-cinza dark:bg-preto w-[40%] h-[60vh] p-[2rem] rounded-3xl justify-evenly">
                ...
                >
                  ...
                  >
                    <p className="mt-2 text-black dark:text-white">
                      Para um diagnóstico mais preciso, forneça detalhes sobre
                      os sintomas que seu veículo está apresentando, o modelo e
                      o ano do carro, e, se possível, o histórico de manutenção.
                      Quanto mais informações você fornecer, mais preciso será o
                ...
                >
                  ...
                  >
                    <p className="mt-2 text-black dark:text-white">
                      Selecionamos nossas mecânicas parceiras com base em
                      critérios rigorosos, incluindo certificações, experiência,
                      e avaliações de clientes. Apenas mecânicas que atendem aos
                      nossos padrões de qualidade e confiabilidade são incluídas
                      em nossa rede.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <p className="mt-2 text-black dark:text-white">
                      Levamos a proteção de dados muito a sério. Todos os dados
                      que você fornece são criptografados e armazenados de
                      acordo com as leis de proteção de dados vigentes. Apenas
                      informações necessárias para o diagnóstico e o agendamento
                      são compartilhadas com as mecânicas parceiras.
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex flex-col bg-cinza dark:bg-preto w-[40%] p-[2rem] rounded-3xl justify-evenly">
                ...
                >
                  ...
                  >
                    <p className="mt-2 text-black dark:text-white">
                      ...
                      relacionados ao serviço de reparo ou manutenção são
                      diretamente cobrados pela mecânica escolhida.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  >
                    <p className="mt-2 text-black dark:text-white">
                      ...
                      formulário de contato disponível em nosso site, ou
                      enviando um e-mail para (phygitalporto@gmail.com). Também
                      oferecemos suporte via chat ao vivo durante o horário
                      comercial.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <p className="mt-2 text-black dark:text-white">
                      Se você não encontrar uma mecânica próxima à sua
                      localização, é possível que ainda não tenhamos uma
                      parceira na sua área. Entre em contato com nosso suporte
                      para verificar outras opções ou para solicitar a inclusão
                      de uma nova mecânica em nossa rede.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-[50%] flex justify-center items-center">
              <div className="space-y-6 overflow-auto overflow-y-scroll items-center w-[60%] h-[40rem] flex-grow flex flex-col m-auto">
                ...
                <div className="p-4 bg-gray-100 dark:bg-cinzaescuro rounded w-[60%] shadow">
                  ...
                  <p className="flex">
                    <MdOutlinePlace className="fa-solid fa-location-dot mr-2 mt-1" />
                    Estrada PRT 163 S/N - ZONA RURAL - CAPITÃO LEÔNIDAS
                    MARQUES/PR
                    <br /> (45) 3286-1419
                  </p>
                  <Link
