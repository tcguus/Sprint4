      ...
      <div className="flex flex-col w-full">
        ...
        <div id="sec2" className="w-full bg-white dark:bg-cinzaescuro min-h-[calc(100vh-3rem)] scroll-mt-[3rem] flex flex-col">
          ...
          <div className="flex mt-auto mb-auto justify-evenly">
            <div className='flex flex-col bg-cinza dark:bg-preto w-[40%] h-[60vh] p-[2rem] rounded-xl justify-evenly'>
              <div
            ...
            <div className='flex flex-col bg-cinza dark:bg-preto w-[40%] p-[2rem] rounded-xl justify-evenly'>
              <div
